...
ice_shifted=min_order+0.5*(max_ice-max_liq)
liq_shifted=min_order-0.5*(max_ice-max_liq)
print("Liquid max:",max_liq)
print("Ice max:",max_ice)
print("Midpoint:",min_order)


os.system('sed -i \'s/MORE_THAN1=.*/MORE_THAN1={{CUBIC D_0={} D_MAX={}}}/g\' ../plumed.order.dat'.format(liq_shifted,ice_shifted))
os.system('sed -i \'s/MORE_THAN2=.*/MORE_THAN2={{CUBIC D_0={} D_MAX={}}}/g\' ../plumed.order.dat'.format(min_order,min_order+0.00001))
